    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-lg animate-fadeIn">
      <div className="relative w-full max-w-lg rounded-3xl p-1 bg-gradient-to-b from-emerald-500 via-[#FF40EB] to-[#9234eb] shadow-[0_0_60px_rgba(16,185,129,0.4)]">
        <div className="bg-[#0b0d16] rounded-[22px] p-6 sm:p-8 text-center relative max-h-[90vh] overflow-y-auto">
          ...
          <button
            onClick={onClose}
            className="absolute top-4 right-4 px-2.5 py-1 rounded-full bg-white/10 hover:bg-white/20 text-gray-300 hover:text-white transition text-xs font-bold cursor-pointer"
            aria-label="Close"
          >
            Close
          </button>
          ...
          {/* Success Badge */}
          <div className="inline-flex items-center text-xs font-bold uppercase tracking-wider text-emerald-400 bg-emerald-500/15 px-3.5 py-1.5 rounded-full border border-emerald-500/30 mb-3 mt-1">
          ...
          <div className="mt-5 p-4 sm:p-5 rounded-2xl bg-gradient-to-b from-white/[0.08] to-white/[0.02] border border-[#FF40EB]/40 shadow-[0_0_30px_rgba(255,64,235,0.2)] text-left">
            ...
            <div className="flex items-center text-[11px] text-emerald-400 font-semibold mb-3">
              <span>{downloadTriggered ? 'Brochure download started automatically' : 'Preparing brochure download...'}</span>
            </div>
            ...
            <a
              ...
              className="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-[#FF40EB] via-[#d922c5] to-[#9234eb] text-white font-black text-xs sm:text-sm uppercase tracking-wider flex items-center justify-center shadow-[0_0_25px_rgba(255,64,235,0.6)] hover:scale-[1.02] active:scale-[0.98] transition cursor-pointer"
            >
            ...
            <div className="text-center mt-2">
              <a
                ...
                className="text-[11px] font-semibold text-[#FF40EB] hover:text-white transition inline-block"
              >
                Click here to preview in browser
              </a>
            </div>
          </div>
          ...
          <div className="mt-4 p-4 rounded-2xl bg-emerald-950/40 border border-emerald-500/30 text-left">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-3 w-full py-3 px-4 rounded-xl bg-[#25D366] hover:bg-[#20ba59] text-black font-extrabold text-xs uppercase tracking-wider flex items-center justify-center transition shadow-[0_0_20px_rgba(37,211,102,0.4)] cursor-pointer"
            >
          ...
          <div className="mt-4 flex flex-col gap-2">
            <a
              ...
              className="py-2.5 px-4 rounded-xl bg-white/10 hover:bg-white/15 text-white font-semibold text-xs flex items-center justify-center transition border border-white/10"
            >
